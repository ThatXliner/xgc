...
> Auto-generated by `xgc generate-skills`. Do not edit manually.
...
| Skill | Description |
|-------|-------------|
| [xgc-shared](../skills/xgc-shared/SKILL.md) | xgc CLI: Shared patterns for authentication, global flags, and output formatting. |
| [xgc-drive](../skills/xgc-drive/SKILL.md) | Google Drive: Manage files, folders, and shared drives. |
| [xgc-sheets](../skills/xgc-sheets/SKILL.md) | Google Sheets: Read and write spreadsheets. |
| [xgc-gmail](../skills/xgc-gmail/SKILL.md) | Gmail: Send, read, and manage email. |
| [xgc-calendar](../skills/xgc-calendar/SKILL.md) | Google Calendar: Manage calendars and events. |
| [xgc-admin-reports](../skills/xgc-admin-reports/SKILL.md) | Google Workspace Admin SDK: Audit logs and usage reports. |
| [xgc-docs](../skills/xgc-docs/SKILL.md) | Read and write Google Docs. |
| [xgc-slides](../skills/xgc-slides/SKILL.md) | Google Slides: Read and write presentations. |
| [xgc-tasks](../skills/xgc-tasks/SKILL.md) | Google Tasks: Manage task lists and tasks. |
| [xgc-people](../skills/xgc-people/SKILL.md) | Google People: Manage contacts and profiles. |
| [xgc-chat](../skills/xgc-chat/SKILL.md) | Google Chat: Manage Chat spaces and messages. |
| [xgc-classroom](../skills/xgc-classroom/SKILL.md) | Google Classroom: Manage classes, rosters, and coursework. |
| [xgc-forms](../skills/xgc-forms/SKILL.md) | Read and write Google Forms. |
| [xgc-keep](../skills/xgc-keep/SKILL.md) | Manage Google Keep notes. |
| [xgc-meet](../skills/xgc-meet/SKILL.md) | Manage Google Meet conferences. |
| [xgc-events](../skills/xgc-events/SKILL.md) | Subscribe to Google Workspace events. |
| [xgc-modelarmor](../skills/xgc-modelarmor/SKILL.md) | Google Model Armor: Filter user-generated content for safety. |
| [xgc-workflow](../skills/xgc-workflow/SKILL.md) | Google Workflow: Cross-service productivity workflows. |
| [xgc-script](../skills/xgc-script/SKILL.md) | Manage Google Apps Script projects. |
...
| Skill | Description |
|-------|-------------|
| [xgc-drive-upload](../skills/xgc-drive-upload/SKILL.md) | Google Drive: Upload a file with automatic metadata. |
| [xgc-sheets-append](../skills/xgc-sheets-append/SKILL.md) | Google Sheets: Append a row to a spreadsheet. |
| [xgc-sheets-read](../skills/xgc-sheets-read/SKILL.md) | Google Sheets: Read values from a spreadsheet. |
| [xgc-gmail-send](../skills/xgc-gmail-send/SKILL.md) | Gmail: Send an email. |
| [xgc-gmail-triage](../skills/xgc-gmail-triage/SKILL.md) | Gmail: Show unread inbox summary (sender, subject, date). |
| [xgc-gmail-reply](../skills/xgc-gmail-reply/SKILL.md) | Gmail: Reply to a message (handles threading automatically). |
| [xgc-gmail-reply-all](../skills/xgc-gmail-reply-all/SKILL.md) | Gmail: Reply-all to a message (handles threading automatically). |
| [xgc-gmail-forward](../skills/xgc-gmail-forward/SKILL.md) | Gmail: Forward a message to new recipients. |
| [xgc-gmail-read](../skills/xgc-gmail-read/SKILL.md) | Gmail: Read a message and extract its body or headers. |
| [xgc-gmail-watch](../skills/xgc-gmail-watch/SKILL.md) | Gmail: Watch for new emails and stream them as NDJSON. |
| [xgc-calendar-insert](../skills/xgc-calendar-insert/SKILL.md) | Google Calendar: Create a new event. |
| [xgc-calendar-agenda](../skills/xgc-calendar-agenda/SKILL.md) | Google Calendar: Show upcoming events across all calendars. |
| [xgc-docs-write](../skills/xgc-docs-write/SKILL.md) | Google Docs: Append text to a document. |
| [xgc-chat-send](../skills/xgc-chat-send/SKILL.md) | Google Chat: Send a message to a space. |
| [xgc-events-subscribe](../skills/xgc-events-subscribe/SKILL.md) | Google Workspace Events: Subscribe to Workspace events and stream them as NDJSON. |
| [xgc-events-renew](../skills/xgc-events-renew/SKILL.md) | Google Workspace Events: Renew/reactivate Workspace Events subscriptions. |
| [xgc-modelarmor-sanitize-prompt](../skills/xgc-modelarmor-sanitize-prompt/SKILL.md) | Google Model Armor: Sanitize a user prompt through a Model Armor template. |
| [xgc-modelarmor-sanitize-response](../skills/xgc-modelarmor-sanitize-response/SKILL.md) | Google Model Armor: Sanitize a model response through a Model Armor template. |
| [xgc-modelarmor-create-template](../skills/xgc-modelarmor-create-template/SKILL.md) | Google Model Armor: Create a new Model Armor template. |
| [xgc-workflow-standup-report](../skills/xgc-workflow-standup-report/SKILL.md) | Google Workflow: Today's meetings + open tasks as a standup summary. |
| [xgc-workflow-meeting-prep](../skills/xgc-workflow-meeting-prep/SKILL.md) | Google Workflow: Prepare for your next meeting: agenda, attendees, and linked docs. |
| [xgc-workflow-email-to-task](../skills/xgc-workflow-email-to-task/SKILL.md) | Google Workflow: Convert a Gmail message into a Google Tasks entry. |
| [xgc-workflow-weekly-digest](../skills/xgc-workflow-weekly-digest/SKILL.md) | Google Workflow: Weekly summary: this week's meetings + unread email count. |
| [xgc-workflow-file-announce](../skills/xgc-workflow-file-announce/SKILL.md) | Google Workflow: Announce a Drive file in a Chat space. |
| [xgc-script-push](../skills/xgc-script-push/SKILL.md) | Google Apps Script: Upload local files to an Apps Script project. |
