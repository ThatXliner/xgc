...
```bash
xgc drive <resource> <method> [flags]
```
...
| Command | Description |
|---------|-------------|
| [`+upload`](../xgc-drive-upload/SKILL.md) | Upload a file with automatic metadata |
...
xgc schema drive.<resource>.<method>
```
