...
```bash
xgc sheets <resource> <method> [flags]
```
...
| Command | Description |
|---------|-------------|
| [`+append`](../xgc-sheets-append/SKILL.md) | Append a row to a spreadsheet |
| [`+read`](../xgc-sheets-read/SKILL.md) | Read values from a spreadsheet |
...
xgc schema sheets.<resource>.<method>
```
