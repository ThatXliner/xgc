...
```bash
xgc calendar <resource> <method> [flags]
```
...
| Command | Description |
|---------|-------------|
| [`+insert`](../xgc-calendar-insert/SKILL.md) | create a new event |
| [`+agenda`](../xgc-calendar-agenda/SKILL.md) | Show upcoming events across all calendars |
...
xgc schema calendar.<resource>.<method>
```
