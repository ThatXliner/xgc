...
metadata:
  ...
  openclaw:
    ...
    requires:
      bins:
        - xgc
    cliHelp: "xgc admin-reports --help"
---
...
```bash
xgc admin-reports <resource> <method> [flags]
```
...
xgc admin-reports --help

# Inspect a method's required params, types, and defaults
xgc schema admin-reports.<resource>.<method>
```
